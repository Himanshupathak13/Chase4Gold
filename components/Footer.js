            ...
            <footer className="text-center text-lg-start bg-dark text-muted sticky-bottom">
                ...
                >
                    <div className="me-5 d-none d-lg-block">
                        <span>Youths Get connected with us on our social networks</span>
                    </div>
                    <div>
                        <a href="https://www.youtube.com/channel/UCQpYfyhXOyzO4p1vueqb7EA" className="me-4 ">
                            <i className="fab fa-youtube"></i>
                        </a>
                        <a href="https://www.facebook.com/profile.php?id=100077065181963" className="me-4 ">
                            <i className="fab fa-facebook-f"></i>
                        </a>
                        <a href="" className="me-4 ">
                            <i className="fab fa-twitter"></i>
                        </a>
                        <a href="https://www.instagram.com/chase4gold/" className="me-4 ">
                        ...
                        <div className="row mt-3">
                            <div className="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                                <h6 className="text-uppercase fw-bold mb-4">
                                    <i className="fas fa-gem me-3"></i>CHASE4GOLD
                                </h6>
                                <p>
                                    This website will be very useful for youths to get them familiar with the olympic sports.
                                </p>
                            </div>
                            ...
                            <div className="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                                ...
                                <p><i className="fas fa-home me-3"></i> Gwalior,Madhya Pradesh</p>
                                <p>
                                    <i className="fas fa-envelope me-3"></i>
                                    olympicschase4gold@gmail.com
                                </p>
                                <p><i className="fas fa-phone me-3"></i>+919340222066</p>
                            </div>
                ...
                <div className="text-center p-4" style={{ backgroundColor: "rgba(0, 0, 0, 0.05)" }}>
                    © 2022 Copyright:
                    <a className="text-reset text-decoration-none fw-bold" href="">CHASE4GOLD.com</a>
                </div>
            </footer>
        </div>
